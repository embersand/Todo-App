  ...
  for (item in storage) {
    ...
    newItem.innerHTML = `
      <li class="main__list-item">
          <input class="main__text text" value="${task.text}">
...
buttonAdd.addEventListener('click', () => {
  ...
  newItem.innerHTML = `
    <li class="main__list-item">
        <input class="main__text text" placeholder="New task">
        <div class="main__list-buttons edit">
          <button class="main__list-button">
            <svg width="800px" height="800px" viewBox="0 -0.5 21 21" version="1.1" xmlns="http://www.w3.org/2000/svg"
              xmlns:xlink="http://www.w3.org/1999/xlink">
    ...
    `
  list.append(newItem);
  localStorage.setItem(task.id.toString(), task.text.toString());
  number++;
});

const inputs = document.querySelectorAll('.main__text');
